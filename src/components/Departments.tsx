        ...
        >
          {departments.map((dept, index) => {
            ...
            return (
              ...
              >
                <Card 
                  className="group cursor-pointer overflow-hidden bg-white border-0 shadow-lg hover:shadow-2xl transition-all duration-500 rounded-3xl touch-manipulation flex flex-col"
                ...
                >
                  ...
                  <div className="p-6 md:p-8 flex flex-col flex-1">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h3 className="text-2xl md:text-3xl font-bold text-gray-900 group-hover:text-gray-800 transition-colors leading-tight">
                          {dept.title}
                        </h3>
                      </div>
                  ...
                  <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-all duration-500 pointer-events-none">
                    <div className={`absolute inset-0 rounded-3xl blur-xl ${
                      dept.isInternational 
                        ? 'bg-gradient-to-r from-blue-200/30 to-indigo-400/30' 
                        : 'bg-gradient-to-r from-yellow-200/30 to-orange-400/30'
                    }`} />
                  </div>
                </Card>
              </motion.div>
